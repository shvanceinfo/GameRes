      ...
      case 5: {
        if (tag == 42) {
         parse_map4:
          DO_(input->IncrementRecursionDepth());
         parse_loop_map4:
          ::google::protobuf::scoped_ptr<MapOut_Map4Entry> entry(map4_.NewEntry());
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, entry.get()));
          (*mutable_map4())[entry->key()] = *entry->mutable_value();
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            entry->mutable_value()->data(),
            entry->mutable_value()->length(),
            ::google::protobuf::internal::WireFormatLite::PARSE,
...
::google::protobuf::uint8* MapOutWireFormat_Map1Entry::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
::google::protobuf::uint8* MapOutWireFormat_Map2Entry::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
::google::protobuf::uint8* MapOutWireFormat_Map3Entry::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
::google::protobuf::uint8* MapOutWireFormat_Map4Entry::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
::google::protobuf::uint8* MapOutWireFormat::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
